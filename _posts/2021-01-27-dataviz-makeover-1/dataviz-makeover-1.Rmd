...
However, the median age is simply an indication on the chart and does not provide any meaning to the interpretation of chart. Also, the source of the data for median age is not stated.

4. The narrative compared the increment of resident labour force aged 55 and over and decline of resident labour force aged 25 to 54.    
However, the chart depicts the time series data; in this case, a 5-year age bands were used.   
Hence, there is no standardization of age bands as explained in the lead-in paragraph and chart, and this may hinder the proper interpretation of data. 
...
1. To modify the title to “Resident Labour Force in Percentage” to clearly reflect that the data presented is in percentage.

2. To add another bar graph to show the percentage of Labour Force Participation Rate.   
This allows user to identify the relationship between Labour Force Participation Rate and Resident labour force for different age group. 

3. To remove median age from the chart as it does not serve any meaningful interpretation to the data.

4. To create 3 age bands (for example, age bands between 0 to 24, 25 to 54 and 55 & over) for comparing characteristics across time period.
...
1. In order to clearly explain the changes of labour force participation rate and resident labour force for 2-year period across all age bands, there are proposed 3 charts instead of 1 chart as shown in the initial visualization.
...
3. All age groups are classified into 3 distinct age band (15-24, 25-54, 55&above) so that user can directly relate to the lead-in paragraph.

#  3.0 Using Tableau, design the proposed data visualization.

Data Visualization can be found in Tableau Public:     https://public.tableau.com/profile/elaine3214#!/vizhome/Book4_16118304881740/Dashboard

#  4.0 Provide step-by-step description on how the data visualization was prepared.

## Data Source
Data Source is extracted from https://stats.mom.gov.sg/Pages/Labour-Force-Tables2019.aspx
...
![Calculation](./image/Picture1.PNG)

3. Rename the file to Table 7.

### Table 5

1. Covert data headers to dimensions for source data, **Table 5: Resident Labour Force Participation Rate by Age and Sex, 2009-2019 (June)** as per below table:

![Convert Headers](./image/Picture7.PNG)  
...
![Extract Data](./image/Picture3.PNG)

### Import to Tableau

2. Import Table 5 into tableau:   
![Import Data](./image/Picture8.PNG){width=70%}

3. Change data type for **[Year]** from Number to **Date**.
![Change Data Type](./image/Picture15.PNG) 

### Create chart to show the Percentage of Labour Force Participation Rate for all Age Group
...
![Picture10](./image/Picture10.PNG){width=40%}

### Create Dual Axis

9. Drag **[Percentage of Resident Labour Force]** to Columns and Select Dual Axis.

10. Format horizontal axis’s scale to Percentage with 0 decimal place and select Synchronise Axis.
...
3. Change data type for **[Year]** from Number to **Date**.
![Picture15](./image/Picture15.PNG) 

### Create chart to show an overview of the Percentage of Resident Labour Force for all Age Group 

4. Drag **[Age]** and **[Year]** to Columns and **[Percentage of Resident Labour Force]** to Rows.   

![Picture12](./image/Picture12.PNG){width=70%}    

![Picture13](./image/Picture13.PNG){width=70%} 
...
9. Format axis scale to Percentage with 0 decimal place and select Synchronise Axis.
...
5. Format horizontal axis’s scale to Percentage with 0 decimal place and select Synchronise Axis.
...
8. In order to group the age into different age bands, select the range of dates in the axis and right-click the group field, and then rename it to 3 age groups (namely 15-24, 25-54 and 55 & over).
...
11. For all charts, drag **[Years]** to **Color** under the Marks Card and select diverging color palette to identify respective years.
...
Definition of labour force and labour force participation rate (extracted from Ministry of Mapower website[^1]):   
